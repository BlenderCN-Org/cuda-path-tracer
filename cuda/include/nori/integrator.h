...
public:
    virtual size_t getSize() const  override  {return sizeof(Integrator);}
    /// Release all memory
    virtual ~Integrator() { }
    enum integratorType {EPathMis} integratorType;
...
#define CallIntegrator(object,function,...) CallCuda1(Integrator,integratorType,object,function,const,EPathMis,PathMisIntegrator,__VA_ARGS__)
NORI_NAMESPACE_END
